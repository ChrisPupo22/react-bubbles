...
- [ ] Explain what a token is used for.
      A token is used for authentication purposes. It allows you to gain access to certain portions of a site by getting a unique token.

- [ ] What steps can you take in your web apps to keep your data secure?
      You can make a private Route 
- [ ] Describe how web servers work.
      Web servers are computers that are able to take in and give out data and code to help other computers either view websites or host specific data or sites on the internet
